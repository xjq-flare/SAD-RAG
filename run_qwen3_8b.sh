#!/bin/bash
# =============================================================================
# SAD-RAG Inference Script: Qwen3-8B
# =============================================================================
# This script runs the SAD-RAG inference pipeline using Qwen3-8B.
# Make sure the vLLM server is running before executing this script.
#
# Usage: bash run_qwen3_8b.sh
# =============================================================================
...
# We dynamically modify __main__.py to set dataset_paths
MAIN_PY="${ENTRY_DIR}/__main__.py"

# Generate the dataset_paths list
DATASET_PATHS_PY="["
for dataset in "${DATASETS[@]}"; do
...
# Use Python to safely update the dataset_paths in __main__.py
python3 - << PYEOF
import re
...
# Replace the dataset_paths block
content = re.sub(
    r'    dataset_paths = \[\s*\]',
    new_paths.rstrip(),
    content
